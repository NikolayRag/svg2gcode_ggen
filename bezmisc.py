...
def bezierparameterize(xyBezier):
    #parametric bezier
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
    x0=bx0
    y0=by0
    cx=3*(bx1-x0)
    bx=3*(bx2-bx1)-cx
...
def linebezierintersect(xyLine, xyBezier):
    #parametric line
    ((lx1,ly1), (lx2,ly2)) = xyLine
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
    dd=lx1
    cc=lx2-lx1
    bb=ly1
...
def beziertatslope(xyBezier, xyPoint):
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
    (dy,dx) = xyPoint
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def tpoint(xyPoint1, xyPoint2, t):
    (x1,y1) = xyPoint1
    (x2,y2) = xyPoint2
    return x1+t*(x2-x1),y1+t*(y2-y1)
def beziersplitatt(xyBezier, t):
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
...
'''
def pointdistance(xyPoint1, xyPoint2):
    (x1,y1) = xyPoint1
    (x2,y2) = xyPoint2
...
def bezierlengthSimpson(xyBezier, tolerance = 0.001):
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
...
def beziertatlength(xyBezier, l = 0.5, tolerance = 0.001):
    ((bx0,by0), (bx1,by1), (bx2,by2), (bx3,by3)) = xyBezier
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy
